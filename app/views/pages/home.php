            ...
            <div class="course-card bg-white rounded-lg shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 flex flex-col">
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-xl font-bold text-gray-800 mb-2 pr-20 line-clamp-2" title="<?= htmlspecialchars($course['title']) ?>">
                            <?= htmlspecialchars($course['title']) ?>
                        </h3>
                        
                        <?php 
                        // REGRAS DA CATEGORIA: Exibe a tag APENAS se o curso for "Gratuito" (que agora é o valor numérico 0)
                        if (isset($course['category']) && (int)$course['category'] === 0) : 
                        ?>
                            <span class="absolute top-0 right-0 bg-green-100 text-green-800 text-xs font-bold px-3 py-1 rounded-full border border-green-200 shadow-sm category-tag">
                                Gratuito
                            </span>
                        <?php endif; ?>
                    </div>
                    ...
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3 flex-grow">
                        <?= htmlspecialchars($course['description'] ?? 'Sem descrição disponível.') ?>
