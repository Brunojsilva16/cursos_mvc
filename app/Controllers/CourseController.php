...
class CourseController extends BaseController
{
    ...
    public function index()
    {
        ...
        // Busca TODOS os cursos com status 'published' no banco de dados
        $courses = $courseModel->findAllPublished();
        // 1. Verifica se o usuário está logado (Ajuste a variável de sessão se a sua for diferente)
        ...
        $courseModel = new CourseModel();
        // 2. Busca SOMENTE os cursos vinculados à conta do usuário logado
        $courses = $courseModel->findAllByUserId($userId);

        // 3. Renderiza a view da Home com os cursos dele
        $this->render('home', [
            'title' => 'Nossos Cursos',
            'courses' => $courses
        ]);
